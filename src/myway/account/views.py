...
from myway.account.forms import RegistrationForm
from myway.account.models import UserProfile
...
def register(request):
    ...
    if request.user.is_authenticated():
        ...
        return render_to_response('account/register.html', {'has_account':True}, context_instance=RequestContext(request))
...
def confirm(request, activation_key):
    if request.user.is_authenticated():
        return render_to_response('account/confirm.html', {'has_account':True})
